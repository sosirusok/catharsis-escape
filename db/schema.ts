...
export const reservations = sqliteTable(
  "reservations",
  {
    ...
    termsVersion: text("terms_version").notNull().default("2026-08-15-npay"),
    refundPolicyVersion: text("refund_policy_version").notNull().default("2026-08-15-npay"),
    ...
    paymentTaxScopeAmount: integer("payment_tax_scope_amount").notNull().default(0),
    paymentTaxExScopeAmount: integer("payment_tax_ex_scope_amount").notNull().default(0),
    paymentRefundRequester: text("payment_refund_requester").notNull().default("2"),
  ...
  (table) => [
    ...
    check("reservations_payment_provider_check", sql`${table.paymentProvider} IN ('toss','naverpay')`),
    check("reservations_payment_refund_requester_check", sql`${table.paymentRefundRequester} IN ('1','2')`),
  ],
);
...
export const bookingSettings = sqliteTable("booking_settings", {
  ...
  consentVersion: text("consent_version").notNull().default("2026-08-15-npay"),
  termsVersion: text("terms_version").notNull().default("2026-08-15-npay"),
  refundPolicyVersion: text("refund_policy_version").notNull().default("2026-08-15-npay"),
