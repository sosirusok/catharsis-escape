...
function TermsPolicy({ settings }: { settings: PolicySettings }) {
  return (
    <>
      ...
      <section><h2>제4조 변경·취소·환불</h2><p>예약 변경, 취소와 환불에는 결제할 때 확인한 취소·환불정책이 적용됩니다. 날짜·시간·테마 변경은 기존 예약 취소 후 새 예약으로 처리될 수 있습니다. 카드 환불은 원래 결제수단으로 처리하며 카드사 반영 시점은 결제수단에 따라 달라질 수 있습니다.</p></section>
